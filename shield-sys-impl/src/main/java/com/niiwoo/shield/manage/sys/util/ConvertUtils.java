...
public abstract class ConvertUtils {
     ...
     */
    public static <E extends Serializable, D extends Serializable> PageResponseDTO<D> convertPage(PageResponseDTO<E> pageResponseDTO, Class<D> dtoClass) {
    ...
    public static Object invokeWriteMethod(Object obj, String propertyName, Object... args) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new BizException("MUC10005", clazz.getName(), propertyName);
        }
    }
    ...
    public static Object invokeReadMethod(Object obj, String propertyName) {
        ...
        try {
            ...
            throw new BizException("MUC10004", clazz.getName(), propertyName);
        }
    }
}
